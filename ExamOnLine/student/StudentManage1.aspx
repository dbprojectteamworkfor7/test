        ...
        <table bgcolor="#ffffff" border="0" bordercolor="#215dc6" cellpadding="0" cellspacing="0"
            ...
            <tr>
                ...
                <td bgcolor="#333300" style="text-align: left; height: 26px;">
                    <span style="font-size: 9pt; color: #ffffff">&nbsp;学生ID：</span><asp:Label ID="lblwz" runat="server" Font-Size="9pt" ForeColor="White"></asp:Label>&nbsp;&nbsp;<span
                        style="color: #ffffff">学生姓名：<asp:Label ID="lblname" runat="server" Font-Size="9pt"></asp:Label></span>&nbsp;
                    <span style="color: #ffffff">用户身份：学生&nbsp; 
                    </span>
            ...
            <tr>
                <td height="155">
                    <iframe name="menu" frameborder=0 scrolling=auto style="width: 596px; height: 422px" src=studentexam.aspx></iframe>
                    &nbsp;</td>
            </tr>
            <tr>
